    ...
    <div className="light w-full min-h-screen bg-slate-50 text-slate-900 font-sans flex flex-col justify-center items-center px-4 py-8 sm:py-12 relative overflow-y-auto">
      ...
      <div className="relative z-10 w-full max-w-md flex flex-col gap-5 my-auto">
        ...
        <div className="bg-white/80 backdrop-blur-md border border-slate-200/80 rounded-xl p-5 sm:p-8 shadow-2xl shadow-slate-100/50 flex flex-col gap-5">
          <div className="text-center sm:text-left">
            ...
            <p className="text-xs sm:text-sm font-semibold text-slate-400 mt-1">
              Join the vetted network of clients and talent
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-primary hover:bg-primary-hover text-white font-bold py-3.5 rounded-xl transition-all duration-200 shadow-md hover:shadow-lg active:scale-[0.98] mt-2 cursor-pointer flex items-center justify-center gap-2 disabled:opacity-50"
            >
              {loading ? (
                <>
        ...
        <p className="text-center text-xs sm:text-sm text-slate-500 font-semibold select-none">
          ...
          <a href="/login" className="text-[#0a5a54] hover:text-[#073f3a] font-extrabold hover:underline">
            Login here
          </a>
        </p>

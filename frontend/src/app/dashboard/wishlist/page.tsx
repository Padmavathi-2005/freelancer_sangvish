    ...
    <div className="space-y-8 text-left animate-fadeIn">
      ...
      {activeTab === "gigs" && (
        gigsWishlist.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {gigsWishlist.map((gig) => {
              ...
              return (
                <div
                  key={gig.gig_id}
                  className="bg-white border border-slate-200/80 rounded-3xl overflow-hidden shadow-sm hover:shadow-md hover:border-slate-350 transition-all duration-200 flex flex-col justify-between"
                >
                  <div>
                    {imgUrl ? (
                      ...
                      <div className="relative w-full h-44 bg-gradient-to-tr from-slate-50 to-slate-100 flex items-center justify-center border-b border-slate-200 text-slate-350 select-none text-xs font-extrabold uppercase">
                    ...
                    <div className="p-5 text-left">
                      ...
                      <div className="flex items-center gap-4 text-xxs font-bold text-slate-400 mt-4 border-t border-slate-100/60 pt-3">
          ...
          <div className="border-2 border-dashed border-slate-200 rounded-3xl p-16 text-center bg-white">
        ...
        projectsWishlist.length > 0 ? (
          <div className="space-y-4">
            {projectsWishlist.map((job) => (
              <div
                key={job.job_id}
                className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm hover:shadow-md transition-all flex flex-col justify-between gap-5 relative group"
              >
                <div>
                  ...
                  <div className="sm:border-l sm:border-slate-100 sm:pl-6 flex flex-col justify-between items-start sm:items-end gap-4 self-stretch min-w-[120px]">
                    ...
                    <div className="flex items-center gap-2 w-full justify-end">
                      ...
                      <button
                        ...
                        className="bg-primary hover:bg-primary-hover text-white text-[10px] font-black py-2.5 px-4 rounded-xl shadow-sm transition cursor-pointer text-center border-none"
                      >
                        View Profile
                      </button>
                    </div>

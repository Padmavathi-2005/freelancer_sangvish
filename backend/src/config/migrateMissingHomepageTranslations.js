...
async function run() {
  ...
  const translations = [
    // English (EN)
    { code: 'EN', key: 'nav_home', value: 'Home' },
    ...
    { code: 'EN', key: 'transform your team with top talent discovery', value: 'Transform Your Team with Top Talent Discovery' },
    { code: 'EN', key: 'flourish in a thriving freelance ecosystem dedicated to excellence and limitless opportunities.', value: 'Flourish in a thriving freelance ecosystem dedicated to excellence and limitless opportunities.' },
    ...
    // Arabic (AR)
    { code: 'AR', key: 'nav_home', value: 'الرئيسية' },
    ...
    { code: 'AR', key: 'transform your team with top talent discovery', value: 'حول فريقك مع اكتشاف أفضل المواهب' },
    { code: 'AR', key: 'flourish in a thriving freelance ecosystem dedicated to excellence and limitless opportunities.', value: 'انمُ في بيئة العمل الحر المزدهرة المخصصة للتميز والفرص غير المحدودة.' },
    ...
    // French (FR)
    { code: 'FR', key: 'nav_home', value: 'Accueil' },
    ...
    { code: 'FR', key: 'transform your team with top talent discovery', value: 'Transformez votre équipe grâce aux meilleurs talents' },
    { code: 'FR', key: 'flourish in a thriving freelance ecosystem dedicated to excellence and limitless opportunities.', value: 'Épanouissez-vous dans un écosystème freelance florissant dédié à l\'excellence et aux opportunités illimitées.' },
    ...
    // German (DE)
    { code: 'DE', key: 'nav_home', value: 'Startseite' },
    ...
    { code: 'DE', key: 'transform your team with top talent discovery', value: 'Transformieren Sie Ihr Team mit Spitzen-Talenten' },
    { code: 'DE', key: 'flourish in a thriving freelance ecosystem dedicated to excellence and limitless opportunities.', value: 'Entfalten Sie sich in einem florierenden Freelance-Ökosystem, das auf Exzellenz und unbegrenzte Möglichkeiten ausgerichtet ist.' },
